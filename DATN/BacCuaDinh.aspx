...
<body>
    <h2>Bậc của đỉnh.</h2>
    <h3>Định nghĩa:</h3>
<p>Bậc của đỉnh v trong đồ thị vô hướng G=(V,E), ký hiệu deg(v), là số các cạnh liên thuộc với nó<br /> riêng khuyên tại một đỉnh được tính hai lần cho bậc của nó Deg(v) = 1 -> đỉnh treo Deg(v) = 0 -> đỉnh cô lập.<br />
Trong đồ thị có hướng G=(V,E)<br />
• Bán bậc ra của một đỉnh v (𝑑𝑒𝑔+ (v)) là số cung đi ra khỏi nó.<br /> 
