...
<body>
    ...
    <h2>Quy tắc thay thế thứ nhất:</h2>
    ...
    <h3>Chú ý:</h3>
    <p>Ta đã sử dụng khái niệm biểu thức con theo một nghĩa hết sức tự nhiên: dạng mệnh đề F "xuất hiện trong E.</p>
    <p>Hay nói cách khác E có thể xây dựng  từ F và một số dạng mệnh đề khác qua các phép nối."</p>
    <hr />
    <h3>Ví dụ:</h3>
    ...
    <h2>Quy tắc thay thế thứ hai:</h2>
    <p>Giả sử dạng mệnh đề E(p, q, r,...) là một hằng đúng. Nếu ta thay thế những nơi p xuất hiện trong E bởi một dạng mệnh đề tùy ý F(p', q', r',...) thì dạng mệnh đề nhận được theo các biến p,q,r...p', q',r'...vẫn còn là một hằng đúng.</p>
    <hr />
