...
<body>
   <h2>Ma trận liền kề.</h2>
    <h3>Định nghĩa:</h3>
    <p>Ma trận liền kề của đồ thị G=(V,E) ứng với thứ tự các đỉnh v1 , v2 , … , vn là ma trận cấp M x M </p>
 	<p>𝐴 = ( 𝑎𝑖𝑗 ) 𝑖≤𝑗, 𝑗 ≤ 𝑛 &#8712 𝑀(𝑛, 𝑍) </p>
<p>Trong đó aij là số cạnh hoặc cung nối từ v(i) tới v(j) . </p>
<p>Ma trận liền kề của 1 đồ thị vô hướng là ma trận đối xứng </p>
<p>Ma trận liền kề của 1 đồ thị có hướng là ma trận không đối xứng.</p>
